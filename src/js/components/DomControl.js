...
import { AddChangeItem } from './add_item_form/AddChangeItem'
...
export class DomControl {
  ...
  onAddItem = () => {
    const addForm = new AddChangeItem()
  ...
  onRedact = (event) => {
    ...
    const redactElement = new AddChangeItem(element.children[0].innerText, element.children[1].innerText)
